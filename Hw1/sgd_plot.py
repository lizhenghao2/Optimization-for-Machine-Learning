...
# Plot the trajectory of x during stochastic gradient descent for the first step size
...
plt.tight_layout()
plt.savefig('level_sets_2D_sgd.png', dpi=150)

print(f"\nLevel set plot saved as 'level_sets_2D_sgd.png'")
...
ax.plot(trajectory_x2, trajectory_x3, trajectory_z, 'r-', linewidth=2, label=f'SGD trajectory (alpha = {step_sizes[0]})')
...
ax.set_title(f'3D Level Sets with SGD Trajectory (x1 fixed at {x1_fixed:.4f})', fontsize=13)
ax.legend(fontsize=10)
ax.view_init(elev=25, azim=120)

plt.tight_layout()
plt.savefig('level_sets_3D_sgd.png', dpi=150)
print(f"3D level set plot saved as 'level_sets_3D_sgd.png'")
