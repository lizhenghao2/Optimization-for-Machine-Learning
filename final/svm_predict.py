...
plot_figures.plot_confusion_matrix(y_test, y_pred, save_path='figures/svm/confusion_matrix.png')
plot_figures.plot_precision_recall_curve(y_test, y_scores, save_path='figures/svm/precision_recall_curve.png')
plot_figures.plot_roc_curve(y_test, y_scores, save_path='figures/svm/roc_curve.png')
